...
const INITIAL_FORM_DATA: FormData = {
  ...
  country: '', email: '', password: '', birthDate: '',
  ...
  const handleRegister = async (onSuccessCallback?: () => void) => {
    ...
    try {
      ...
      if (response) {
        ...
        // Call the success callback BEFORE resetting form data
        // so the navigation can access the form data
        if (onSuccessCallback) {
          onSuccessCallback();
        }
        
        // Reset form after a short delay to allow navigation to complete
        setTimeout(() => {
