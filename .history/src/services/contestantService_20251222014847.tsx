...
export const registerContestant = async (userData: RegisterContestantRequest): Promise<RegisterContestantRequest> => {
  return await apiRequest<RegisterContestantResponse>('/users', 'POST', userData);
};