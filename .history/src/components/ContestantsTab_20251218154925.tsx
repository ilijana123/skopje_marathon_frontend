...
export const ContestantsTab = () => {
  // 1. Rename this to filteredContestants so the rest of your JSX works
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Handle the case where data might be the Response object or null
