...
import { fetchContestantsWithErrorHandling, fetchContestantsByCategory, fetchContestantsByName } from '../services/contestantService';
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (searchTerm) {
        ...
        data = await fetchContestantsW();
      }
      setContestants(data.filter(p => p.isPaid));
      setLoading(false);
    };
