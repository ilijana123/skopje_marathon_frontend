...
// FIX: Define the props interface even if you plan to fetch data internally
interface ContestantsTabProps {
  contestants?: Contestant[]; // The '?' makes it optional
}
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Only show paid contestants in the public list
