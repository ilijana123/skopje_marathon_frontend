...
import { calculateAge, validateForm } from '../services/contestantService';
...
interface RegisterTabProps {
  ...
  formError: string;
  formSuccess: string;
  onRegister: (data: FormData, category: Category } null) => void;
  onRemove?: () => void;
    ...
    <FormCard>
      <CardContent sx={{ p: 3 }}>
        ...
        <RegisterContestantButtonBox>
          <RegisterContestantButton
              variant="contained"
              onClick={() => onRegister(formData, selectedCategory)}
          >
          РЕГИСТРИРАЈ УЧЕСНИК →
          </RegisterContestantButton>   
        </RegisterContestantButtonBox>
